...
#
package marketcheck_api_sdk_perl::ListingsApi;
...
# @param boolean $include_lease Boolean param to search for listings that include leasing options in them (optional)
# @param boolean $include_finance Boolean param to search for listings that include finance options in them (optional)
...
# @param boolean $nodedup If nodedup is set to true then will give results without is_searchable i.e multiple listings for single vin (optional)
...
# @param boolean $exclude_certified Boolean param to exclude certified cars from search results (optional)
{
    my $params = {
    'api_key' => {
        data_type => 'string',
    ...
    'nodedup' => {
        data_type => 'boolean',
        description => 'If nodedup is set to true then will give results without is_searchable i.e multiple listings for single vin',
        required => '0',
    },
    'state' => {
        data_type => 'string',
...
sub search {
    ...
    # query params
    if ( exists $args{'include_lease'}) {
        $query_params->{'include_lease'} = $self->{api_client}->to_query_value($args{'include_lease'});
    }

    # query params
    if ( exists $args{'include_finance'}) {
        $query_params->{'include_finance'} = $self->{api_client}->to_query_value($args{'include_finance'});
    }

    # query params
    if ( exists $args{'lease_term'}) {
        $query_params->{'lease_term'} = $self->{api_client}->to_query_value($args{'lease_term'});
    }

    # query params
    if ( exists $args{'lease_down_payment'}) {
        $query_params->{'lease_down_payment'} = $self->{api_client}->to_query_value($args{'lease_down_payment'});
    }

    # query params
    if ( exists $args{'lease_emp'}) {
        $query_params->{'lease_emp'} = $self->{api_client}->to_query_value($args{'lease_emp'});
    }

    # query params
    if ( exists $args{'finance_loan_term'}) {
        $query_params->{'finance_loan_term'} = $self->{api_client}->to_query_value($args{'finance_loan_term'});
    }

    # query params
    if ( exists $args{'finance_loan_apr'}) {
        $query_params->{'finance_loan_apr'} = $self->{api_client}->to_query_value($args{'finance_loan_apr'});
    }

    # query params
    if ( exists $args{'finance_emp'}) {
        $query_params->{'finance_emp'} = $self->{api_client}->to_query_value($args{'finance_emp'});
    }

    # query params
    if ( exists $args{'finance_down_payment'}) {
        $query_params->{'finance_down_payment'} = $self->{api_client}->to_query_value($args{'finance_down_payment'});
    }

    # query params
    if ( exists $args{'finance_down_payment_per'}) {
        $query_params->{'finance_down_payment_per'} = $self->{api_client}->to_query_value($args{'finance_down_payment_per'});
    }
    ...
    # query params
    if ( exists $args{'carfax_1_owner'}) {
        $query_params->{'carfax_1_owner'} = $self->{api_client}->to_query_value($args{'carfax_1_owner'});
    }

    # query params
    if ( exists $args{'carfax_clean_title'}) {
        $query_params->{'carfax_clean_title'} = $self->{api_client}->to_query_value($args{'carfax_clean_title'});
    }
    ...
    # query params
    if ( exists $args{'exclude_certified'}) {
        $query_params->{'exclude_certified'} = $self->{api_client}->to_query_value($args{'exclude_certified'});
    }
