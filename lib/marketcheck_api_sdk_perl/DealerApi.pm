...
#
package marketcheck_api_sdk_perl::DealerApi;
...
# @param Number $rows Number of results to return. Default is 10. Max is 50 (optional)
# @param Number $start Offset for the search results. Default is 1. (optional)
{
    my $params = {
    'latitude' => {
        data_type => 'double',
