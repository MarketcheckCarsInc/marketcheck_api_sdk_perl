...
#
package marketcheck_api_sdk_perl::Role;
use utf8;
...
has api_factory => ( is => 'ro',
                     isa => 'marketcheck_api_sdk_perl::ApiFactory',
                     builder => '_build_af',
                     lazy => 1,
...
has _cfg => ( is => 'ro',
              isa => 'marketcheck_api_sdk_perl::Configuration',
              default => sub { marketcheck_api_sdk_perl::Configuration->new() },
              );

has version_info => ( is => 'ro',
                      isa => 'HashRef',
                      default => sub { {
                          app_name => 'Marketcheck Cars API',
                          app_version => '1.0.3',
...
sub _build_af {
	...
	return marketcheck_api_sdk_perl::ApiFactory->new(%args);
}
...
=head2 Marketcheck Cars API version: 1.0.3
