...
#
package marketcheck_api_sdk_perl::Object::SafetyRating;
...
__PACKAGE__->class_documentation({description => 'Describes the Safety Ratings of current listing',
                                  class => 'SafetyRating',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'passenger_front_rating' => {
    	datatype => 'Number',
    	base_name => 'passenger_front_rating',
...
__PACKAGE__->swagger_types( {
    ...
    'roll_over_rating' => 'Number',
    'driver_side_rating' => 'Number',
    'driver_front_rating' => 'Number',
    'passenger_front_rating' => 'Number'
} );
