...
#
package marketcheck_api_sdk_perl::Object::Sales;
...
__PACKAGE__->class_documentation({description => 'Sales count query response',
                                  class => 'Sales',
                                  required => [], # TODO
}                                 );
...
__PACKAGE__->method_documentation({
    ...
    'dom_stats' => {
    	datatype => 'SalesStats',
    	base_name => 'dom_stats',
    	description => 'Days on market stats',
    	format => '',
    	read_only => '',
    		},
    'price_stats' => {
    	datatype => 'SalesStats',
    	base_name => 'price_stats',
    ...
    'miles_stats' => {
    	datatype => 'SalesStats',
    	base_name => 'miles_stats',
    	description => 'Miles stats',
    	format => '',
    	read_only => '',
    		},
});
