...
#
package marketcheck_api_sdk_perl::Object::DealerLandingPage;
...
__PACKAGE__->class_documentation({description => 'Describes the dealer landing page (SRP) HTML object',
