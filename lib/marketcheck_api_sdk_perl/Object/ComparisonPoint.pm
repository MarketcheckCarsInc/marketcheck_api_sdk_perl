...
#
package marketcheck_api_sdk_perl::Object::ComparisonPoint;
...
__PACKAGE__->method_documentation({
    'similar_vehicles_count' => {
    	datatype => 'Number',
    	base_name => 'similar_vehicles_count',
...
__PACKAGE__->swagger_types( {
    'similar_vehicles_count' => 'Number',
    'dealer_indicator' => 'string',
    'vin_price' => 'Number',
    'fair_deal_price' => 'Number'
} );
